...
if __name__ == '__main__':
    ...
    # print(samples.shape)
    # 读取所有 PNG 图片
    # folder = r'D:\yuzhm01\Desktop\NeRF-windows\data\ggbond\images'
    # images = []
    ...
    path = r'D:\yuzhm01\Desktop\NeRF-windows\data\ggbond\images'
    filelist = glob.glob(os.path.join(path, '*.jpg'))
    filelist = sorted(filelist)  # 按照文件数字进行顺序排序
    print(len(filelist))
    imgs2video('outputs\test.mp4', filelist, 10.0)
